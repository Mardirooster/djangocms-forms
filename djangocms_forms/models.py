...
class FormField(models.Model):
    ...
    def build_widget_attrs(self, extra_attrs=None):
        ...
        css_classes = {
            '__all__': (),
            'text': ('textinput form-control',),
            'textarea': ('textarea form-control', ),
            'email': ('emailinput form-control', ),
            'number': ('integerfield form-control', ),
            'phone': ('telephoneinput form-control', ),
            'url': ('urlfield form-control', ),
            'checkbox': ('booleanfield form-control',),
            'checkbox_multiple': ('checkboxselectmultiple form-control', ),
            'select': ('choicefield form-control', ),
            'radio': ('radioselect form-control', ),
            'file': ('filefield form-control', ),
            'date': ('dateinput form-control', ),
            'time': ('timeinput form-control', ),
            'password': ('passwordinput form-control', ),
            'hidden': ('hiddeninput form-control', ),
        }
